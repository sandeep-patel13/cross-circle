        ...
        <div class="mb-5 w-full">
            ...
            <div class="flex flex-col space-y-4 items-center">
                <div class="flex items-center">
                    ...
                    <label for="startGame" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Start
                        Game</label>
                </div>
                <div class="flex items-center">
                    <input wire:model="gameStarter" id="letStartGame" type="radio" value="system" name="gameStarter"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="letStartGame" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Let
                        System Start
                        Game</label>
                </div>
            </div>
